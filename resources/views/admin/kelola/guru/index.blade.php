...
@section('main')
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    ...
                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#add-guru-modal">Add guru</button>
                </div>
                            ...
                            @foreach ($gurus as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/kelola/guru/' . $item->id) }}" class="btn btn-outline-danger btn-sm" data-confirm-delete="true">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <!-- end row-->
    <div id="add-guru-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
